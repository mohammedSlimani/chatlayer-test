...
`get any string, that starts with the left delimiter, doesnt contain the right delimiter, and ends with the right delimiter`
...
specify that it shouldn't contain the right delimiter is to avoid merging the matches together
